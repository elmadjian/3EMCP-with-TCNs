...
class RecordingProcessor:
    ...
    def load_recording(self, fname, data_format=None,
        ...
        if not data_format.startswith('labelled'):
            ...
            gaze_points = self._saccade_detector.detect(gaze_points, inplace=True)
            ...
            gaze_points = self._blink_detector.detect(gaze_points, inplace=True)
            # mark fixations (inside the previously detected intersaccadic intervals)
            gaze_points = self._fixation_detector.detect(gaze_points, inplace=True)
